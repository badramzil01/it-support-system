...
<div class="space-y-4">
    ...
    {{-- HEADER PROFIL --}}
    <div class="bg-gradient-to-r from-blue-500 via-indigo-500 to-violet-600 rounded-2xl p-6 text-white shadow-lg shadow-blue-500/20">
        ...
        <div class="stat-card bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800 p-4 md:p-5 shadow-sm">
            <div class="flex items-start justify-between mb-3">
                <div class="flex h-10 w-10 items-center justify-center rounded-xl bg-blue-50 dark:bg-blue-900/30">
                    <svg class="h-5 w-5 text-blue-600 dark:text-blue-400" viewBox="0 0 20 20" fill="currentColor"><path d="M9 4.804A7.968 7.968 0 0 0 5.8 3.25H4.5a.5.5 0 0 0-.5.5v10a.5.5 0 0 0 .5.5H5.8A7.968 7.968 0 0 0 9 12.696V4.804Z"/></svg>
                </div>
            </div>
        ...
        <div class="stat-card bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800 p-4 md:p-5 shadow-sm">
            <div class="flex items-start justify-between mb-3">
                <div class="flex h-10 w-10 items-center justify-center rounded-xl bg-indigo-50 dark:bg-indigo-900/30">
                    <svg class="h-5 w-5 text-indigo-600 dark:text-indigo-400" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M12.232 4.232a2.5 2.5 0 0 1 3.536 3.536l-1.225 1.224a.75.75 0 0 0 1.061 1.061l1.224-1.225a4 4 0 0 0-5.656-5.656L8.929 5.414a.75.75 0 1 0 1.06 1.061l2.243-2.243Z" clip-rule="evenodd"/></svg>
                </div>
            </div>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-4">
                ...
                <div class="flex items-center gap-2">
                    <div class="flex-1">
                        ...
                        <div class="h-1.5 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden">
                            ...
                            <div class="h-full bg-blue-500 rounded-full" style="width: {{ ($cat->total / $max) * 100 }}%"></div>
                        </div>
                    </div>
                </div>
                @empty
        ...
        <div class="xl:col-span-2 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-sm overflow-hidden">
            ...
            <div class="divide-y divide-slate-100 dark:divide-slate-800">
                @forelse($items as $i)
                <a href="{{ route('support.ui.knowledge.show', $i) }}" class="flex items-start gap-3 px-5 py-3 hover:bg-slate-50 dark:hover:bg-slate-800/40 transition group">
                    ...
                    <div class="min-w-0 flex-1">
                        <p class="text-sm font-medium text-slate-800 dark:text-slate-200 truncate group-hover:text-blue-600 dark:group-hover:text-blue-400 transition">{{ $i->problem_keywords }}</p>
