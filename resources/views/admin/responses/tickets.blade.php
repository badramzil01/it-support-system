...
<div class="flex h-screen">
    ...
    <aside class="w-64 bg-slate-900 text-white flex flex-col">
        ...
        <div>
            ...
            <a href="#" class="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-slate-800">  Audit Log</a>
        ...
        <div>
            ...
            <a href="#" class="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-slate-800">Workflow Monitoring </a>
            <a href="#" class="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-slate-800">AI Monitoring </a>
