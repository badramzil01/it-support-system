{{-- SIDEBAR ADMIN (style Support IT) --}}
<aside id="sidebar" class="fixed inset-y-0 left-0 z-30 flex flex-col border-r border-slate-800/80 bg-[#111318] transform -translate-x-full md:translate-x-0">
    ...
    <nav class="flex-1 overflow-y-auto px-2 py-3 space-y-5">
        ...
        <div>
            ...
            <a href="{{ route('admin.dashboard') }}" class="nav-item {{ request()->routeIs('admin.dashboard') ? 'active' : '' }} flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-slate-400 hover:text-white transition">
        ...
        <div>
            ...
            <a href="{{ route('admin.ui.conversations.index') }}" class="nav-item {{ request()->routeIs('admin.ui.conversations.*') ? 'active' : '' }} flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-slate-400 hover:text-white transition">
            ...
            <a href="{{ route('admin.ui.internal.index') }}" class="nav-item {{ request()->routeIs('admin.ui.internal.*') ? 'active' : '' }} flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-slate-400 hover:text-white transition">
            ...
            <a href="{{ route('admin.ui.tickets.index') }}" class="nav-item {{ request()->routeIs('admin.ui.tickets.*') ? 'active' : '' }} flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-slate-400 hover:text-white transition">
            ...
            <a href="{{ route('admin.escalations.index') }}" class="nav-item {{ request()->routeIs('admin.escalations*') ? 'active' : '' }} flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-slate-400 hover:text-white transition">
        ...
        <div>
            ...
            <a href="{{ route('admin.ui.knowledge.index') }}" class="nav-item {{ request()->routeIs('admin.ui.knowledge.*') ? 'active' : '' }} flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-slate-400 hover:text-white transition">
        ...
        <div>
            ...
            <a href="{{ route('admin.notifications') }}" class="nav-item {{ request()->routeIs('admin.notifications*') ? 'active' : '' }} flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-slate-400 hover:text-white transition">
            ...
            <a href="{{ route('admin.ui.monitoring.index') }}" class="nav-item {{ request()->routeIs('admin.ui.monitoring.*') ? 'active' : '' }} flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-slate-400 hover:text-white transition">
        ...
        <div>
            ...
            <a href="{{ route('admin.ui.users.index') }}" class="nav-item {{ request()->routeIs('admin.ui.users.*') ? 'active' : '' }} flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-slate-400 hover:text-white transition">
            ...
            <a href="{{ route('admin.support-teams.index') }}" class="nav-item {{ request()->routeIs('admin.support-teams.*') ? 'active' : '' }} flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-slate-400 hover:text-white transition">
            ...
            <a href="{{ route('admin.ui.settings.index') }}" class="nav-item {{ request()->routeIs('admin.ui.settings.*') ? 'active' : '' }} flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-slate-400 hover:text-white transition">
    ...
    <div class="shrink-0 p-3 border-t border-slate-800/80">
        <div class="flex items-center gap-2.5 px-2.5 py-2 rounded-xl hover:bg-slate-800/60 transition cursor-pointer group">
            ...
            <div class="min-w-0 flex-1">
                <p class="truncate text-xs font-semibold text-slate-200">{{ auth()->user()->name ?? 'Admin' }}</p>
                <p class="truncate text-[10px] text-slate-500">{{ auth()->user()->email ?? 'admin@it.com' }}</p>
            </div>
        </div>
    </div>
</aside>
