...
<div id="cmdPalette" class="fixed top-[15%] left-1/2 -translate-x-1/2 z-50 w-full max-w-xl pointer-events-none opacity-0 scale-95">
    <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700 overflow-hidden">
        ...
        <div class="p-2 max-h-80 overflow-y-auto">
            ...
            <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700/60 text-sm text-slate-700 dark:text-slate-200 transition">
            ...
            <a href="{{ route('admin.ui.tickets.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700/60 text-sm text-slate-700 dark:text-slate-200 transition">
            ...
            <a href="{{ route('admin.ui.conversations.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700/60 text-sm text-slate-700 dark:text-slate-200 transition">
            ...
            <a href="{{ route('admin.ui.knowledge.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700/60 text-sm text-slate-700 dark:text-slate-200 transition">
