...
<div class="space-y-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
        ...
        ?>
        <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-sm p-5 cursor-pointer hover:shadow-md transition card-service" data-service="<?php echo e($s['id']); ?>">
            <div class="flex items-center justify-between mb-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-[11px] <?php echo e($statusLabel['text']); ?> font-medium flex items-center gap-1.5" id="status-<?php echo e($s['id']); ?>">
                            <span class="h-1.5 w-1.5 rounded-full <?php echo e($statusColor); ?> <?php echo e($s['status']==='online' ? 'pulse' : ''); ?>"></span>
                            <span class="status-label"><?php echo e($statusLabel['label']); ?></span>
                        </p>
                    </div>
                </div>
                <div>
                    <button class="test-btn p-2 text-xs text-slate-500 hover:text-amber-600 transition" data-service="<?php echo e($s['id']); ?>" title="Tester la connexion">
            ...
            <dl class="space-y-2 text-xs">
                ...
                <div class="flex justify-between"><dt class="text-slate-500 dark:text-slate-400">Temps de réponse</dt><dd class="font-medium text-slate-700 dark:text-slate-200" id="time-<?php echo e($s['id']); ?>"><?php echo e($s['response']); ?></dd></div>
                ...
                <div class="flex justify-between"><dt class="text-slate-500 dark:text-slate-400">Dernière sync</dt><dd class="font-medium text-slate-700 dark:text-slate-200" id="sync-<?php echo e($s['id']); ?>"><?php echo e($s['last_sync']); ?></dd></div>
            </dl>
        </div>
