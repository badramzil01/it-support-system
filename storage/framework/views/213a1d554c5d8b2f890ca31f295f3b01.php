        ...
        <div class="messages-wrap" id="msgsWrap">
            <div class="messages-inner" id="msgsInner">
                <div class="welcome" id="welcome">
                    ...
                    <div class="welcome-title">Bonjour <?php echo e(auth()->user()->name); ?> 👋</div>
                    <p class="welcome-sub">
...
<?php /**PATH C:\xamp2\htdocs\prj\pfe-laravel\it-support-system\resources\views/chat.blade.php ENDPATH**/ ?>