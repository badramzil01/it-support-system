...
<div class="bg-gradient-to-r from-amber-500 to-orange-600 rounded-2xl p-5 mb-6 text-white shadow-lg shadow-amber-500/20">
    <div class="flex items-center gap-4">
        ...
        <a href="<?php echo e(route('admin.ui.knowledge.author', $stats['top_contributor']->id)); ?>" class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-white/20 hover:bg-white/30 text-sm font-semibold transition">
            Voir profil
...
<div class="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-4 mb-4">
    <form method="GET" action="<?php echo e(route('admin.ui.knowledge.index')); ?>">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-3">
            <div class="sm:col-span-2">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Question, réponse, auteur, email…" class="w-full rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 py-2 pl-9 pr-3 text-sm outline-none focus:border-amber-500 focus:ring-2 focus:ring-amber-100 dark:focus:ring-amber-950 placeholder:text-slate-400">
                </div>
            </div>
            <div>
            ...
            <div>
                ...
                <input type="date" name="date_from" value="<?php echo e(request('date_from')); ?>" class="w-full rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 py-2 px-3 text-sm outline-none focus:border-amber-500 focus:ring-2 focus:ring-amber-100 dark:focus:ring-amber-950">
            </div>
            <div>
                <label class="block mb-1 text-[11px] font-medium text-slate-500 dark:text-slate-400">Jusqu'au</label>
                <input type="date" name="date_to" value="<?php echo e(request('date_to')); ?>" class="w-full rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 py-2 px-3 text-sm outline-none focus:border-amber-500 focus:ring-2 focus:ring-amber-100 dark:focus:ring-amber-950">
            </div>
            <div class="sm:col-span-2 lg:col-span-4 xl:col-span-6 flex flex-wrap items-center justify-end gap-2">
                <a href="<?php echo e(route('admin.ui.knowledge.index')); ?>" class="inline-flex items-center gap-1.5 rounded-lg border border-slate-200 dark:border-slate-700 px-4 py-2 text-sm font-medium text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 transition">Réinitialiser</a>
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                ...
                <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/40 transition group">
                    ...
                    <td class="px-4 py-3">
                        <?php if($item->author): ?>
                        <a href="<?php echo e(route('admin.ui.knowledge.author', $item->author->id)); ?>" class="flex items-center gap-2 hover:underline">
                            <div class="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-amber-500 to-orange-600 text-[10px] font-bold text-white"><?php echo e(Str::upper(Str::substr($item->author->name, 0, 1))); ?></div>
                            <div class="min-w-0">
                    ...
                    <td class="px-4 py-3 whitespace-nowrap text-right">
                        <div class="flex items-center justify-end gap-1">
                            <a href="<?php echo e(route('admin.ui.knowledge.show', $item)); ?>" class="inline-flex items-center gap-1 rounded-lg bg-amber-600 px-2.5 py-1.5 text-[11px] font-medium text-white hover:bg-amber-700 transition" title="Voir">
                            ...
                            <form method="POST" action="<?php echo e(route('admin.ui.knowledge.destroy', $item)); ?>" onsubmit="return confirm('Confirmer la suppression de cette solution ?')" class="inline">
...
<?php echo $__env->make('admin.knowledge.partials.modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
function openKbModal(item = null) {
    ...
    if (item) {
        ...
        form.action = '<?php echo e(url("admin/ui/knowledge")); ?>/' + item.id;
        method.value = 'PUT';
        ...
        form.action = '<?php echo e(route("admin.ui.knowledge.store")); ?>';
        method.value = 'POST';
        form.reset();
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xamp2\htdocs\prj\pfe-laravel\it-support-system\resources\views/admin/knowledge/index.blade.php ENDPATH**/ ?>