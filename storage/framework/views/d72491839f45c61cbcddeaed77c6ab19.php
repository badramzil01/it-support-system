                            ...
                            <th class="px-4 py-3 text-left text-[11px] font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400 whitespace-nowrap">
                                <a href="<?php echo e(sortUrl($col, $sort ?? '', $direction ?? 'desc')); ?>"
                                   class="inline-flex items-center gap-1 hover:text-slate-900 dark:hover:text-slate-100 transition">
                                    ...
                                    <?php if($icon): ?>
                                        <span class="text-blue-600 dark:text-amber-400"><?php echo e($icon); ?></span>
                                    <?php else: ?>
...
<?php echo $__env->make('support.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\badr\Desktop\support it\support-system\resources\views/admin/tickets/index.blade.php ENDPATH**/ ?>