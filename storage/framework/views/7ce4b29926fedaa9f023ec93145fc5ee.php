...
<div id="kbModal" class="hidden fixed inset-0 z-50 overflow-y-auto" aria-modal="true" role="dialog">
    <div class="flex items-center justify-center min-h-screen p-4">
        ...
        <div class="relative bg-white dark:bg-slate-900 rounded-2xl shadow-2xl w-full max-w-2xl border border-slate-200 dark:border-slate-700">
            ...
            <form id="kbForm" method="POST" action="<?php echo e(route('support.ui.knowledge.store')); ?>" class="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
                <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <textarea id="kbProblemKeywords" name="problem_keywords" required rows="2" placeholder="Décrivez le problème ou la question..." class="w-full rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 px-3 py-2 text-sm outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 dark:focus:ring-blue-950"></textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea id="kbSolution" name="solution" required rows="5" placeholder="Solution complète, étapes, bonnes pratiques..." class="w-full rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 px-3 py-2 text-sm outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 dark:focus:ring-blue-950"></textarea>
                </div>

                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                        <label class="block text-xs font-semibold text-slate-700 dark:text-slate-200 mb-1.5">Catégorie</label>
                        <input id="kbCategory" type="text" name="category" list="kbCategoriesList" placeholder="ex: VPN, Email, Hardware..." class="w-full rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 px-3 py-2 text-sm outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 dark:focus:ring-blue-950">
                    ...
                    <div>
                        ...
                        <select id="kbStatus" name="status" class="w-full rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 px-3 py-2 text-sm outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 dark:focus:ring-blue-950">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                        ...
                        <input id="kbTags" type="text" name="tags" placeholder="vpn, windows... (séparés par virgule)" class="w-full rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 px-3 py-2 text-sm outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 dark:focus:ring-blue-950">
                    </div>
                    <div>
                        <label class="block text-xs font-semibold text-slate-700 dark:text-slate-200 mb-1.5">Auteur</label>
                        <input type="hidden" id="kbAuthorId" name="author_id" value="<?php echo e(auth()->id()); ?>">
                        <div class="w-full rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-100 dark:bg-slate-800/60 px-3 py-2 text-sm text-slate-600 dark:text-slate-300 cursor-not-allowed">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                        ...
                        <select id="kbSource" name="source" class="w-full rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 px-3 py-2 text-sm outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 dark:focus:ring-blue-950">
                    ...
                    <div>
                        ...
                        <input id="kbConfidence" type="number" min="0" max="100" step="1" name="confidence" placeholder="0-100" class="w-full rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 px-3 py-2 text-sm outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 dark:focus:ring-blue-950">
                    </div>
                </div>
                ...
                <div class="flex flex-wrap items-center justify-end gap-2 pt-2 border-t border-slate-200 dark:border-slate-700">
                    ...
                    <button type="submit" class="inline-flex items-center gap-1.5 rounded-lg bg-blue-600 hover:bg-blue-700 px-4 py-2 text-sm font-semibold text-white transition">
...
<?php /**PATH C:\xamp2\htdocs\prj\pfe-laravel\it-support-system\resources\views/support/knowledge/partials/modal.blade.php ENDPATH**/ ?>